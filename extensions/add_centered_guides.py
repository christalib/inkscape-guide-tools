...
def drawGuide(position, orientation, parent):
    ...
    etree.SubElement(parent, '{http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd}guide', {
...
class addCenteredGuides(inkex.Effect):
    ...
    def effect(self):
        ...
        drawCenteredGuides(center_pos_x, center_pos_y,
                           include_hor, include_vert, namedview)
